  ...
  win.document.write(`
    ...
    <div class="totals">
      <table>
        ...
        <tr><td>Envío</td><td style="text-align:right;color:${shipping===0?'#1a7c3e':'inherit'}">${shipping===0?'<strong>¡Gratis!</strong>':'RD$ '+shipping.toLocaleString('es-DO',{minimumFractionDigits:2})}</td></tr>
        ${descuento > 0 ? `<tr style="color:#1a7c3e;font-weight:600"><td><i>🏷️ Descuento${cuponUsado ? ` (${cuponUsado})` : ''}</i></td><td style="text-align:right">- RD$ ${descuento.toLocaleString('es-DO',{minimumFractionDigits:2})}</td></tr>` : ''}
