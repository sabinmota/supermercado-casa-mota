...
const ROLES = {
  superadmin: {
    ...
    color: '#7c3aed',
    icon:  'fa-crown',
    sections: ['dashboard','products','orders','inventory','customers','staff','drivers','loyalty','reportes','cupones','notificaciones','settings','categories','respaldo','ventaspos'],
    canEditPrices:    true,
  ...
  admin: {
    ...
    color: '#1565c0',
    icon:  'fa-user-shield',
    sections: ['dashboard','products','orders','inventory','customers','drivers','loyalty','reportes','cupones','notificaciones','settings','categories','respaldo','ventaspos'],
    canEditPrices:    true,
    canDeleteProducts:true,
    canCreateProducts:true,
